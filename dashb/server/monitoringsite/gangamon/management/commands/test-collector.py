...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        #msghosts, port = ["dev.msg.cern.ch"], 6163
        import socket
        ...
        for server in msghosts:
            ...
            #self.add_listener(GangaListener(), server, port, [prodstr('/queue/t3mon_proof_jobs')])
            ...
            self.add_listener(GangaUsageListener(), server, port, [prodstr('/queue/ganga.status')])
